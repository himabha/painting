...
3. Go to the 'Widgets' menu and show the options panel for the widget you would like to hide or show.
4. Open the selection box, select the device you want to show or hide the widget, and that's it.
