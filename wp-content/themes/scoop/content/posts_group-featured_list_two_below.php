<?php
/**
 * Posts Group: Featured Post // List Two Posts Below
 */
...
if ( $_current_widget_instance['is_first_item'] ) : ?>
	<div <?php post_class( 'post-group media featured-post grid-item list-item col-sm-12' ); ?>>
...
<?php else : ?>
	<div <?php post_class( 'post-group media grid-item list-item col-sm-6 col-xs-12' ); ?>>
		<div class="item-inner">
