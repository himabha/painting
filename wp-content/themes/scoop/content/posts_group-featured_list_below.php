<?php
/**
 * Posts Group: Featured Post // List Posts Below
 */
...
if ( $_current_widget_instance['is_first_item'] ) : ?>
	<div <?php post_class( 'post-group grid-item featured-post' ); ?>>
		...
		<div class="caption">
			<?php if ( 'show' === $_current_widget_instance['featured_show_title'] ) : ?>
				<h3 class="grid-heading"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h3>
			<?php endif; ?>
...
<?php else : ?>
	<div <?php post_class( 'post-group media list-item' ); ?>>
