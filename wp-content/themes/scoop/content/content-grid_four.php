...
?>
<div id="post-<?php the_ID(); ?>" <?php post_class( apply_filters( 'pojo_post_classes', array( 'grid-item grid-four col-md-3 col-sm-6 col-xs-12', $format_icon_class ), get_post_type() ) ); ?>>
	<div class="item-inner">
		...
		<?php endif; ?>
		<div class="caption">
			<h4 class="grid-heading"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h4>
