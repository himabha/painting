...
function po_breadcrumbs_need_to_show( $view = 'content' ) {
	...
	if ( ( empty( $sub_header_style ) && ! po_is_page_header_support( get_post_type( $parent_id ) ) ) || in_array( $sub_header_style, array( 'none', 'slideshow', 'rev_slider' ) ) || ( ! is_singular() && ! is_page() ) ) {
