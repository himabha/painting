...
class Pojo_Woocommerce_Integration {
	...
	public function section_woocommerce( $sections = array() ) {
		...
		if ( current_theme_supports( 'pojo-wc-menu-cart' ) ) {
			$fields[] = array(
				...
				'title' => __( 'WooCommerce Menu Cart', 'pojo' ),
	...
	protected function _get_wc_cart_menu_item() {
        ...
        $menu_item.= ($cart_contents_count > 0) ? $cart_contents_count : "";
		$menu_item .= '</a>';
			...
			foreach ( WC()->cart->cart_contents as $cart_item ) {
				...
				$menu_item .= strtr(
					...
					array(
						...
						'{product-title}' => $cart_item['data']->post->post_title,
	...
	public function __construct() {
		...
		add_filter( 'add_to_cart_fragments', array( &$this, 'cart_menu_add_to_cart_fragment' ), 10, 2 );
