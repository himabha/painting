		...
		<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			<div class="entry-post">
				<header class="entry-header">
					...
					<div class="entry-meta">
						<?php if ( po_single_metadata_show( 'author' ) ) : ?>
							<span class="entry-user"><?php echo get_avatar( get_the_author_meta( 'email' ), '24' ); ?> <a href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ) ); ?>" rel="author" class="fn"><?php echo get_the_author(); ?></a></span>
						<?php endif; ?>
				...
				<div class="entry-sharing col-sm-1">
					...
					<a class="entry-mail pojo-tooltip" href="mailto:?subject=<?php the_title(); ?>&amp;body=<?php the_permalink(); ?>" title="<?php _e( 'Send a Email', 'pojo' ); ?>">
