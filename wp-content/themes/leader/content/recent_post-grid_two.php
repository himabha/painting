...
?>
<div class="recent-post grid-item grid-two col-md-6 col-sm-12">
	<div class="inbox">
		<?php if ( 'show' === $_current_widget_instance['thumbnail'] ) : ?>
			<?php if ( has_post_format( 'gallery' ) ) :
				...
				if ( ! empty( $gallery_items ) ) :
					foreach ( $gallery_items as $item_id ) :
						...
						$attachment_url = Pojo_Thumbnails::get_attachment_image_src( $item_id, array( 'width' => '270', 'height' => '360' ) );
			...
			elseif ( has_post_format( 'video' ) ) : ?>
				...
				<?php endif; ?>
			<?php else : ?>
				<?php $image_url = Pojo_Thumbnails::get_post_thumbnail_url( array( 'width' => '270', 'height' => '360', 'crop' => true, 'placeholder' => true ) ); ?>
				<a class="image-link pull-left" href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>" rel="bookmark" class="image-link">
