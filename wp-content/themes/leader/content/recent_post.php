...
?>
<div <?php post_class( 'recent-post media list-item' ); ?>>
	<?php if ( 'show' === $_current_widget_instance['thumbnail'] ) : ?>
		<?php if ( has_post_format( 'gallery' ) ) :
			...
			if ( ! empty( $gallery_items ) ) :
				foreach ( $gallery_items as $item_id ) :
					...
					$attachment_url = Pojo_Thumbnails::get_attachment_image_src( $item_id, array( 'width' => '600', 'height' => '490' ) );
		...
		elseif ( has_post_format( 'video' ) ) : ?>
			...
			<?php endif; ?>
		<?php else : ?>
			<?php $image_url = Pojo_Thumbnails::get_post_thumbnail_url( array( 'width' => '600', 'height' => '490', 'crop' => true, 'placeholder' => true ) ); ?>
			<div class="pull-left">
